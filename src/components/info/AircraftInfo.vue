            ...
            <div class="aircraft-wrapper">
              <div class="row">
                <div>
                  ...
                  <span v-if="selectedAircraft[2] != null && selectedAircraft[2].length > 0">{{ selectedAircraft[2] }}</span>
            ...
            <div class="aircraft-wrapper">
              <div class="row">
                <div>
                  ...
                  <span v-if="selectedAircraft[9] != null">{{ selectedAircraft[9] }} m/s</span>
                  <span v-else>N/A</span>
                </div>
                <div class="--underline">
                  <span>Is on Tarmac</span>
                  <span v-if="selectedAircraft[8] === true" style="color: green">Yes</span>
                  <span v-else-if="selectedAircraft[8] === false" style="color: red">No</span>
                </div>
              </div>
              <div class="row">
                <div>
                  <span>Baro Altitude</span>
                  <span v-if="selectedAircraft[7] !== null">{{ selectedAircraft[7] }} m</span>
                  <span v-else>0 m</span>
                </div>
                <div>
                  <span>Vertical speed</span>
                  <span v-if="selectedAircraft[11] !== null">{{ selectedAircraft[11] }} m/s</span>
                  <span v-else>0 m/s</span>
                </div>
              </div>
              <div class="row">
                <div>
                  <span>Geo Altitude</span>
                  <span v-if="selectedAircraft[13] !== null">{{ selectedAircraft[13] }} m</span>
                  <span v-else>N/A</span>
                </div>
                <div>
                  <span>Track</span>
                  <span v-if="selectedAircraft[10] !== null">{{ selectedAircraft[10] }} °</span>
                </div>
              </div>
            </div>
          </section>
            ...
            <div class="aircraft-wrapper">
              <div class="row">
                <div>
                  ...
                  <span v-if="selectedAircraft[0] !== null">{{ selectedAircraft[0].toUpperCase() }}</span>
                  <span v-else>N/A</span>
                </div>
                <div>
                  <span>Squawk</span>
                  <span v-if="selectedAircraft[14] !== null">{{ selectedAircraft[14] }}</span>
                  <span v-else>N/A</span>
                </div>
              </div>
              <div class="row">
                <div>
                  <span>Latitude</span>
                  <span v-if="!!selectedAircraft[6]">{{ selectedAircraft[6] }}</span>
                </div>
                <div>
                  <span>Longitude</span>
                  <span v-if="!!selectedAircraft[5]">{{ selectedAircraft[5] }}</span>
                </div>
              </div>
            </div>
          </section>
